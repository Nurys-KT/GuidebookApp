...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func preloadData() {
        ...
        if !defaults.bool(forKey: Constants.UserDefaultsKey.PRELOAD_DATA) {
            ...
            defaults.set(true, forKey: Constants.UserDefaultsKey.PRELOAD_DATA)
        }
